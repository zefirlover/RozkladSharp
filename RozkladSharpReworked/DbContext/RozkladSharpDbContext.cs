...
namespace RozkladSharp.DomainServices
{
    ...
    {
        public RozkladSharpDbContext(DbContextOptions<RozkladSharpDbContext> options)
            : base(options)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=RozkladSharp;Username=postgres;Password=GBGT7355608");
            }
